...
console.log( multipliedCalc( 3, 11 ));
// 関数問題(オブジェクト)
...
// 理由：バナナの場合、ローカル変数になるためfunctionで宣言した値が出力され、りんごの場合グローバル変数になるため、var定義した値が出力される
...
// 理由：varで日本という値を定義していないため、全てグローバル変数として定義され、ローカル変数として定義したアメリカもグローバル変数としてみなされ、結果日本からアメリカに更新しただけという結果になり値が一緒になる
country = '日本';
...
// 理由:即時関数はスコープを汚染せずに新たなスコープを作成するための唯一の手段のため　
// var shop = 'コンビニ';
// console.log(shop);
(function ( shop ) {
  console.log( shop )
